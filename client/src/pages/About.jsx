  ...
  return (
    <div className="section" style={{ paddingTop: 48 }}>
      <div className="container" style={{ maxWidth: 760 }}>
        ...
        <p style={{ marginBottom: 16, lineHeight: 1.7 }}>
          Our team tests and curates every listing, so what you see is what you get: accurate specs,
          real photos per color, and transparent pricing across every storage option.
        </p>
      </div>
    </div>
  );
